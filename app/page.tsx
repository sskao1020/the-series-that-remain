...
import { externalReception } from "./data/reception";

type Show = { title: string; original: string; year: number; end: number; genre: string; platform: string; score: number; note: string; seasons: string };

const featured: Show[] = [
  { title:"火線重案組", original:"The Wire", year:2002, end:2008, genre:"犯罪", platform:"HBO", score:98, seasons:"5 季", note:"它沒有把制度當成背景，而是當成真正的主角。二十年後再看，城市、媒體與權力的迴圈仍未過時。" },
  { title:"六呎風雲", original:"Six Feet Under", year:2001, end:2005, genre:"家庭", platform:"HBO", score:97, seasons:"5 季", note:"死亡從來不是終點，而是觀看生活的鏡子。少數能隨觀眾年齡改變意義的作品。" },
  { title:"絕命毒師", original:"Breaking Bad", year:2008, end:2013, genre:"犯罪", platform:"AMC", score:96, seasons:"5 季", note:"把選擇、尊嚴與自我欺騙推向近乎古典悲劇的精準敘事。" },
  { title:"廣告狂人", original:"Mad Men", year:2007, end:2015, genre:"劇情", platform:"AMC", score:95, seasons:"7 季", note:"一部關於人如何推銷商品，也如何重新包裝自己的美國小說。" },
  { title:"黑道家族", original:"The Sopranos", year:1999, end:2007, genre:"犯罪", platform:"HBO", score:95, seasons:"6 季", note:"電視反英雄的分水嶺；家庭、暴力與心理治療至今仍互相刺穿。" },
  { title:"守護者", original:"Watchmen", year:2019, end:2019, genre:"迷你影集", platform:"HBO", score:94, seasons:"9 集", note:"不是改編原作，而是讓原作的政治焦慮在另一個時代重新生長。" },
  { title:"繼承之戰", original:"Succession", year:2018, end:2023, genre:"劇情", platform:"HBO", score:94, seasons:"4 季", note:"權力是一種家庭語言，也是一種永遠得不到愛的替代品。" },
  { title:"兄弟連", original:"Band of Brothers", year:2001, end:2001, genre:"迷你影集", platform:"HBO", score:93, seasons:"10 集", note:"宏大戰爭被還原為名字、面孔與彼此承擔的重量。" },
  { title:"美國諜夢", original:"The Americans", year:2013, end:2018, genre:"諜報", platform:"FX", score:92, seasons:"6 季", note:"婚姻與國家忠誠共享同一種秘密、表演與背叛。" },
  { title:"冰血暴", original:"Fargo", year:2014, end:2024, genre:"犯罪", platform:"FX", score:91, seasons:"5 季", note:"以荒謬、罪惡與偶然反覆追問：普通人如何跨過那條線。" },
  { title:"倫敦生活", original:"Fleabag", year:2016, end:2019, genre:"喜劇", platform:"BBC", score:91, seasons:"2 季", note:"用喜劇的速度藏住哀傷，再讓第四面牆成為最私密的告白。" },
...
const extraShowSeeds:[string,string,string,string,number,number][]=[
  ...
  ["法庭女王","The Good Wife","劇情","CBS",2009,2016],["電腦狂人","Halt and Catch Fire","劇情","AMC",2014,2017],["昭雪","Rectify","劇情","Sundance",2013,2016],["火線警探","Justified","犯罪","FX",2010,2015],["海濱帝國","Boardwalk Empire","犯罪","HBO",2010,2014],
  ["副人之仁","Veep","喜劇","HBO",2012,2019],["矽谷群瞎傳","Silicon Valley","喜劇","HBO",2014,2019],["女孩我最大","Girls","喜劇","HBO",2012,2017],["頓悟人生","Enlightened","劇情","HBO",2011,2013],["尋","Looking","劇情","HBO",2014,2016],
  ["墮落街傳奇","The Deuce","劇情","HBO",2017,2019],["我可以毀掉你","I May Destroy You","迷你影集","BBC",2020,2020],["罪","It's a Sin","迷你影集","Channel 4",2021,2021],["第十一號站","Station Eleven","迷你影集","HBO",2021,2022],["成癮劑量","Dopesick","迷你影集","Hulu",2021,2021],
  ["罪夜之奔","The Night Of","迷你影集","HBO",2016,2016],["利器","Sharp Objects","迷你影集","HBO",2018,2018],["有色眼鏡","When They See Us","迷你影集","Netflix",2019,2019],["離經叛道","Unorthodox","迷你影集","Netflix",2020,2020],["無神之境","Godless","迷你影集","Netflix",2017,2017],
  ["瘋子","Maniac","迷你影集","Netflix",2018,2018],["鬼入侵","The Haunting of Hill House","迷你影集","Netflix",2018,2018],["墮落","The Fall","犯罪","BBC",2013,2016],["小鎮疑雲","Broadchurch","犯罪","ITV",2013,2017],["幸福谷","Happy Valley","犯罪","BBC",2014,2023],
  ["謀殺","The Killing","犯罪","AMC",2011,2014],["雙城追凶","The Bridge","犯罪","DR",2011,2018],["中間人先生","Mr Inbetween","犯罪","FX",2018,2021],["亞特蘭大","Atlanta","喜劇","FX",2016,2022],["保留地之犬","Reservation Dogs","喜劇","FX",2021,2023],
...
const strengthOverrides:Record<string,number[]>={
  "The Wire":[0,1,7],"Six Feet Under":[0,1,6],"Breaking Bad":[1,2,4],"Mad Men":[1,0,6],"The Sopranos":[3,1,0],"Watchmen":[3,0,4],"Succession":[1,4,2],"Band of Brothers":[4,1,0],"The Americans":[1,2,6],"Fargo":[4,1,5],"Fleabag":[1,5,3],"Chernobyl":[4,2,0],
  "Twin Peaks":[3,6,0],"The X-Files":[3,0,7],"The West Wing":[1,5,4],"The Shield":[1,2,5],"Lost":[3,5,4],"The Office":[5,6,1],"Arrested Development":[1,5,6],"Battlestar Galactica":[0,1,3],"Deadwood":[1,4,7],"Dexter":[1,5,4],"Glee":[4,5,1],"Downton Abbey":[4,1,6],"Game of Thrones":[4,3,5],"The Newsroom":[1,5,0],"True Detective":[4,1,5],"The Leftovers":[0,1,6],"Better Call Saul":[1,4,2],"Mr. Robot":[4,3,1],"House of Cards":[1,5,4],"Orange Is the New Black":[1,0,3],"The Crown":[4,1,7],"Dark":[2,1,4],"The Good Place":[0,1,2],"Big Little Lies":[1,4,2],"The Queen's Gambit":[4,1,2],"Mare of Easttown":[1,4,2],"Normal People":[1,0,4],"The Underground Railroad":[4,0,3],"This Is Us":[1,0,5],"BoJack Horseman":[1,0,6],"Black Mirror":[0,3,6],"Peaky Blinders":[4,5,1],"Narcos":[4,5,7],"Rome":[4,3,1],"The Pacific":[4,0,1],"The Night Manager":[4,5,1],"Olive Kitteridge":[1,0,2],"Unbelievable":[1,0,2],
  "The Fresh Prince of Bel-Air":[5,6,0],"Frasier":[1,5,6],"Friends":[5,6,1],"ER":[1,5,4],"Buffy the Vampire Slayer":[3,1,0],"Angel":[1,0,6],"Oz":[3,1,7],"Sex and the City":[1,3,5],"The Larry Sanders Show":[3,1,5],"Freaks and Geeks":[1,0,6],"The Good Wife":[1,2,6],"Halt and Catch Fire":[1,0,6],"Rectify":[1,0,7],"Justified":[1,5,2],"Boardwalk Empire":[4,1,7],"Veep":[1,5,3],"Silicon Valley":[1,5,3],"Girls":[1,0,3],"Enlightened":[0,1,6],"Looking":[1,0,4],"The Deuce":[0,4,1],"I May Destroy You":[1,3,0],"It's a Sin":[0,1,2],"Station Eleven":[0,4,6],"Dopesick":[0,1,7],"The Night Of":[1,4,2],"Sharp Objects":[4,1,2],"When They See Us":[0,4,2],"Unorthodox":[1,0,4],"Godless":[4,1,2],"Maniac":[3,4,0],"The Haunting of Hill House":[4,1,0],"The Fall":[1,4,5],"Broadchurch":[1,2,4],"Happy Valley":[1,0,2],"The Killing":[4,1,5],"The Bridge":[1,4,7],"Mr Inbetween":[1,5,2],"Atlanta":[3,0,6],"Reservation Dogs":[0,1,6],"Barry":[1,4,5],"Better Things":[1,0,6],"You're the Worst":[1,5,2],"Crazy Ex-Girlfriend":[3,1,5],"Schitt's Creek":[1,5,6],"Parks and Recreation":[5,6,1],"Community":[3,1,6],"30 Rock":[1,5,3],"Friday Night Lights":[1,0,6],"The Knick":[4,3,1]
};
const topCriteriaFor=(show:Show)=>{
  const indices=strengthOverrides[show.original];
  if(!indices) throw new Error(`Missing score profile: ${show.original}`);
...
export default function Home() {
  ...
  const [saved,setSaved]=useState<string[]>(["六呎風雲"]); const [compare,setCompare]=useState<Show[]>([]); const [active,setActive]=useState<Show|null>(null); const [weightsOpen,setWeightsOpen]=useState(false); const [view,setView]=useState("探索"); const [quiz,setQuiz]=useState(0); const [answers,setAnswers]=useState<string[]>([]); const [quizOpen,setQuizOpen]=useState(false); const [quizPhase,setQuizPhase]=useState<"taste"|"mood">("taste"); const [mood,setMood]=useState(""); const [groupPrefs,setGroupPrefs]=useState([3,4,2,1]); const [advancedOpen,setAdvancedOpen]=useState(false); const [posters,setPosters]=useState<Record<string,string>>({}); const [showAll,setShowAll]=useState(false); const [notes,setNotes]=useState<Record<string,string>>({}); const [toast,setToast]=useState("");
  const personalScore=(s:Show)=>{const factors=[Math.min(100,s.score+(s.genre==="劇情"||s.genre==="犯罪"?3:-2)),Math.min(100,s.score+(s.year<2010?4:0)+(s.genre==="科幻"||s.genre==="迷你影集"?3:0)),Math.min(100,s.score+(s.platform==="HBO"||s.platform==="FX"?3:-1)),s.score];const sum=groupPrefs.reduce((a,b)=>a+b,0);return Math.round(factors.reduce((n,v,i)=>n+v*groupPrefs[i],0)/sum)};
  const list=shows.filter(s=>genre==="全部"||s.genre===genre).sort((a,b)=>sort==="年份"?b.year-a.year:sort==="平台"?a.platform.localeCompare(b.platform):sort==="作品評分"?b.score-a.score:personalScore(b)-personalScore(a));
  useEffect(()=>{let alive=true;Promise.all(shows.map(async s=>{try{const response=await fetch(`https://api.tvmaze.com/singlesearch/shows?q=${encodeURIComponent(imageQueryByTitle[s.title])}`);if(!response.ok)return [s.title,""] as const;const data=await response.json();return [s.title,data.image?.original||data.image?.medium||""] as const}catch{return [s.title,""] as const}})).then(items=>{if(alive)setPosters(Object.fromEntries(items))});return()=>{alive=false}},[]);
  useEffect(()=>{let timer=0;try{const stored=window.localStorage.getItem("series-notes");if(stored)timer=window.setTimeout(()=>setNotes(JSON.parse(stored)),0)}catch{}return()=>window.clearTimeout(timer)},[]);
  const quizData=[
    {q:"一個故事結束後，你最希望留下什麼？",a:["對世界的新理解","某個忘不掉的人","一種純粹的震撼"]},
    {q:"你能接受一部好作品走得多慢？",a:["愈慢愈好，讓我住進去","只要每一步都有意義","我需要被故事往前推"]},
    {q:"如果結局並不討喜，但非常誠實？",a:["這正是我想看的","可以，但前提是完整","我希望至少得到情感回報"]},
    {q:"你更願意重看哪一種時刻？",a:["突然理解整個制度","人物做出艱難選擇","精準又漂亮的高潮"]},
  ];
  const answerQuiz=(answer:string)=>{const next=[...answers,answer];setAnswers(next);if(quiz<quizData.length-1)setQuiz(quiz+1);else{const cerebral=next.filter(x=>x.includes("理解")||x.includes("制度")||x.includes("誠實")).length;setWeights(cerebral>=2?[16,13,10,14,6,5,10,12,7,7]:[9,17,13,8,8,12,12,7,7,7]);setGroupPrefs(cerebral>=2?[3,4,3,2]:[4,3,2,1]);setQuizPhase("mood")}};
  const chooseMood=(choice:string)=>{setMood(choice);setQuizOpen(false)};
  const restartExplore=()=>{setQuiz(0);setAnswers([]);setMood("");setQuizPhase("taste");setQuizOpen(true)};
  const prefWords=["不太重要","普通","很重要","最重要"];
  const groupData=[{name:"故事與人物",note:"人物、劇本、結局與觀看推進感"},{name:"思想與餘韻",note:"跨世代命題、重看價值與時間驗證"},{name:"創作與突破",note:"形式創新、影響力與製作品質"},{name:"歷史與共識",note:"評論、獎項與長期文化位置"}];
  const toggleCompare=(s:Show)=>setCompare(c=>c.some(x=>x.title===s.title)?c.filter(x=>x.title!==s.title):c.length<3?[...c,s]:c);
